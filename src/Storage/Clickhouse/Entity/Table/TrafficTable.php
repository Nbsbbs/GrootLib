...
class TrafficTable implements TableInterface
{
    protected const NAME = 'traffic_events';
    protected const BUFFER_NAME = 'traffic_events_buffer';
    ...
    public function createRow(RotationEvent $event): array
    {
        ...
        $row[ZoneFixedQueryIdField::name()] = (new ZoneFixedQueryIdField($event->getZone()->getFixedSearchId()) ?? 0)->value();
